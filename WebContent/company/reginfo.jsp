	...
	<table width="100%" height="500" border="0" cellpadding="0"
		...
		<tr>
			<td align="center" valign="top"><table width="500" border="0"
					align="center" cellpadding="0" cellspacing="0" bgcolor="#F5f7f7">
					<form name="form" method="post" action="mreginfo.jsp">
						...
						<tr>
							...
							<td width="300"><input name="tel" type="text" id="tel"
								value="<%=rs.getString(5)%>"></td>
						</tr>
						<tr>
							<td width="200" height="22" align="center">Industry:</td>
							<td width="300"><input name="manage" type="text" id="manage"
								value="<%=rs.getString(6)%>"></td>
						</tr>
						<tr>
							<td width="200" height="22" align="center">Location:</td>
							<td width="300"><input name="address" type="text"
								id="address" value="<%=rs.getString(7)%>"></td>
						</tr>
						<tr>
							<td width="200" height="22" align="center">Company
								Description:</td>
							<td width="300"><textarea name="resume" cols="35" rows="5"><%=rs.getString(8)%></textarea>
							</td>
						</tr>
						<tr align="center">
							<td height="35" colspan="2"><input type="submit"
								name="Submit" value="Edit" onClick="return reg()">
