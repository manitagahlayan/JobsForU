		...
		<tr>
			<td align="center" valign="top"><table width="500" border="0"
					...
					<form name="form1" method="post" action="send.jsp">
						<tr align="center">
							<td height="27" colspan="2" bgcolor="#21536A"><div id="reg">Send
									Emails</div></td>
						</tr>
						<tr>
							<td width="200" height="22" align="center">Recipient1:</td>
							<td width="300"><input type="text" name="from"
								value="
<%
...
%>
        "></td>
						...
						<tr>
							<td height="22" colspan="2" align="center"><textarea
									name="message" cols="60" rows="12"></textarea></td>
						</tr>
						<tr>
							<td height="27" colspan="2" align="center"><input
