    ...
    <div class="container">
              ...
              <form>
                <div class="row">
                  <div class="col-md-6 col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <input type="text" class="form-control" id="" name="firstName"placeholder="" value="<%=rs.getString(3)%>">>
                    </div>
                  </div>
                  <div class="col-md-6 col-sm-12 row-space-1">
                    <label class="control-label" for="">Last Name</label>
                    <div id="">
                      <input type="text" class="form-control" id="" name="lastName"placeholder="" value="<%=rs.getString(4)%>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <input type="email" class="form-control" id="" name="email" placeholder="" value="<%=rs.getString(1)%>">
                    </div>
                  </div>
                  <div class="col-md-6 col-sm-12 row-space-1">
                    <label class="control-label" for="">Phone Number</label>
                    <div id="">
                      <input type="tel" class="form-control" id="" name="telephone" placeholder="" value="<%=rs.getString(5)%>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <input type="text" class="form-control" id="" name="address" placeholder="e.g., 1652 Stockton St" value="<%=rs.getString(6)%>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-12 row-space-1">
                    <textarea class="form-control" name="summary" placeholder="describe yourself - skill sets, experience, expectation, etc."
                    style="width:100%; max-width:100%;" rows="6"><%=rs.getString(7)%></textarea>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-12 row-space-1">
                    <label class="control-label" for="">Expected Job Title (Optional)</label>
                    <div id="">
                      <input type="text" class="form-control" id="" name="expectedJob" placeholder="e.g., Product Manager" value="<%=rs.getString(8)%>">
                    </div>
                  </div>
                </div>
              </form>
              ...
              <form>
                <div class="row">
                  <div class="col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <input type="text" class="form-control" id="" name="schoolName"placeholder="" value="<%=rs.getString(10)%>">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
												<select id="" name="schoolStartMonth" class="form-control select select-default" >
                       ...
                       <div class="col-md-2 col-sm-4 col-xs-12">
                        <select name="schoolStartYear" id="" type="singleselect"  class="form-control select select-default">
                      ...
                      <div class="row">
                  <div class="col-sm-12 row-space-1">
                    <label class="control-label" for="">Graduate Date (estimate if attending)</label>
                  </div>
                </div>
                      <div class="row">
                  <div class="col-md-4 col-sm-6 col-xs-12">
												<select id="" name="schoolEndMonth" class="form-control select select-default">
                       ...
                       <div class="col-md-2 col-sm-4 col-xs-12">
                        <select name="schoolEndYear" id="" type="singleselect"  class="form-control select select-default">
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <select name="schoolDegree" id="" type="singleselect" aria-describedby="" class="form-control select select-default">
                        Other
                        <option value="none" selected=""><%=rs.getString(15)%></option>
                        <option value="High School">High School</option>
                        <option value="Associateâs Degree">Associateâs Degree</option>
                        ...
                        <option value="Engineerâs Degree">Engineerâs Degree</option>
                  ...
                  <div class="col-md-6 col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <input type="text" class="form-control" id="" name="schoolMajor" placeholder="" value="<%=rs.getString(16)%>">
                    </div>
                  </div>
                </div>
              </form>
              ...
              <form>
                <div class="row">
                  <div class="col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <input type="text" class="form-control" id="" name="workCompanyName"placeholder="" value="<%=rs.getString(17)%>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <input type="text" class="form-control" id="" name="workJobTitle" placeholder="" value="<%=rs.getString(18)%>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
												<select id="" name="workStartDate" class="form-control select select-default">
                       ...
                       <div class="col-md-2 col-sm-4 col-xs-12">
                        <select name="workStartYear" id="" type="singleselect"  class="form-control select select-default">
                  ...
                  <div class="col-sm-12 row-space-1">
                    <label class="control-label" for="">End Date (Optional)</label>
                      ...
                      <div class="row">
                  <div class="col-md-4 col-sm-6 col-xs-12">
												<select id="" name="workEndMonth" class="form-control select select-default">
                       ...
                       <div class="col-md-2 col-sm-4 col-xs-12">
                        <select name="workEndYear" id="" type="singleselect"  class="form-control select select-default">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 row-space-1">
                    <textarea class="form-control" name="workJobResponsibility" placeholder="" style="width:100%; max-width:100%;" rows="6"><%=rs.getString(23)%></textarea>
                  </div>
                </div>
              ...
              <form>
                <div class="row">
                  <div class="col-sm-12 row-space-1">
                    ...
                    <div id="">
                      <input type="text" class="form-control" id="" name="projectName"placeholder="" value="<%=rs.getString(24)%>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-12 row-space-1">
                    <textarea class="form-control" name="projectDescription" placeholder="" style="width:100%; max-width:100%;" rows="6"><%=rs.getString(25)%></textarea>
                  </div>
                </div>
            ...
            <div class="panel-body">
              <form>
                <div class="row">
                  <div class="col-sm-12 row-space-1">
                    <div id="">
                                        <textarea class="form-control" name="" placeholder="" style="width:100%; max-width:100%;" rows="6"><%=rs.getString(9)%></textarea>
          ...
          <div class="row row-space-top-3">
            <div class="col-sm-6 col-xs-12">
              ...
              <div class="col-sm-6 col-xs-12">
              <a ng-click="cancelForm()" class="btn btn-block btn-default text-capitalize">
                Cancel
              </a>
            </div>
          </div>
