			...
			<td align="center" valign="top">
				<table width="500" border="0" align="center" cellpadding="0"
					...
					<form name="form" method="post" action="mreginfo.jsp">
						<tr align="center">
							<td height="27" colspan="2" bgcolor="#21536A"><div id="reg">Update
									Profile</div></td>
						</tr>
						<tr>
						...
						<tr>
							<td width="200" height="22" align="center">Gender:</td>
							<%int intSex=rs.getInt(5);%>
							<td width="300"><input type="radio" name="sex" value="1"
								<%=intSex==1?strChecked:null%>> Male <input type="radio"
								name="sex" value=0 <%=intSex==0?strChecked:null%>>
								Female</td>
						</tr>
						<tr>
							<td width="200" height="22" align="center">Birthday:</td>
							<td width="300"><input type="text" name="birthday"
								value="<%=rs.getDate(6)%>"> YYYY-MM-DD</td>
						</tr>
						<tr>
						...
						<tr>
							<td width="200" height="22" align="center">Highest Level of
								Education:</td>
						...
						<tr align="center">
							<td height="35" colspan="2"><input type="submit"
								name="Submit" value="Confirm" onClick="return reg()">
