					...
					<form>
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 row-space-1">
								...
								<div id="">
									<input type="email" class="form-control" id="" name="email" placeholder="" disabled value="<%=rs.getString(1)%>">
								</div>
							</div>
							<div class="col-md-6 col-sm-12 row-space-1">
								<label class="control-label" for="">Phone Number</label>
								<div id="">
									<input type="tel" class="form-control" id="" placeholder="e.g. (098)765-4321">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12 row-space-1">
								...
								<div id="">
									<input type="text" class="form-control" id=""
										placeholder="e.g., 2711 N 1st St, San Jose, CA 95134">
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-sm-12 row-space-1">
								<textarea class="form-control" name=""
									...
									style="width: 100%; max-width: 100%;" rows="6"></textarea>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12 row-space-1">
					...
					<form>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-4 col-xs-12">
								<div class="form-control">
									<label><input type="checkbox" ng-model="" name="" id=""
										value=""> Currently Attending </label>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 row-space-1">
								...
								<div id="">
									<select name="" id="" type="singleselect" aria-describedby=""
